...
if __name__=="__main__":
   ...
   lexicon[u"で"] = ["((S\\NP[nom])/(S\\NP[nom]))\\N","(((S\\NP[nom])\\NP[acc])/((S\\NP[nom])\\NP[acc]))\\N","(S[imp]\\S[imp])\\N"]
   ...
   lexicon[u"だろう"] = ["S\\S"]
   #-- (助詞,格助詞,連語)
   lexicon[u"について"] = ["(S/S)\\N"]
   lexicon[u"に於いて"] = ["(S/S)\\N"]
   lexicon[u"に対して"] = ["(S/S)\\N"]
   lexicon[u"によって"] = ["(S/S)\\N"]
   lexicon[u"に関して"] = ["(S/S)\\N"]
   lexicon[u"による"] = ["(N/N)\\N"]
   ...
   lexicon[u"でしょう"] = ["(S\\NP[nom])\\N","(S\\NP[nom])\\N[adj]"]
